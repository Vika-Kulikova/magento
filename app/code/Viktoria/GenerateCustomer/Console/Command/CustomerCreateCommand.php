...
namespace Viktoria\GenerateCustomer\Console\Command;
...
use Viktoria\GenerateCustomer\Helper\Customer;
...
class CustomerCreateCommand extends Command
{
    ...
    {
        return [
            new InputOption(Customer::KEY_QUANTITY, null, InputOption::VALUE_REQUIRED, 'Quantity of generated customers'),
